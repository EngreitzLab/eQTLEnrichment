...
rule make_prediction_table:
	...
	shell:
		...
		# classify variants	
		Rscript {params.codeDir}/classify_enhancer_predictions.R --variants {input.variantsByTissue} --pred {params.outDir}/{wildcards.method}/eGenePrediction/{wildcards.GTExTissue}.temp.predictionTargetGenes.tsv > {output.predTable}
