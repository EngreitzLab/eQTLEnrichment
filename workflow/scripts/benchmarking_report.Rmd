...
```{r setup, include=FALSE, echo=FALSE}
# input files
enrAll.file = snakemake@input$enrAllTable
predAll.file = snakemake@input$predictionMetrics
...
write.table(enr.all, file='/oak/stanford/groups/engreitz/Users/sheth/eQTLEnrichment/workflow/results.test.NEW/enrTablePlotting.tsv', 
...
# eQTL benchmarking report
- This report presents benchmarking results for the following methods:(pred name long for each method).
- For distance stratified plots, eVariant-eGene distances were stratified at the following bp values: (distances minus 30Mb)
