...
for (i in 1:length(methods)) {
  ...
  mp = ggplotly(m, tooltip='text') %>% layout(margin = list(b = 160), xaxis = list(tickangle = -60))
...
```{r predictionGraph, echo=FALSE, fig.width=9, fig.cap=cap}
...
```{r ppvGraph, echo=FALSE, fig.width=9, fig.cap=cap}
